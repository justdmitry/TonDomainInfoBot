...
Send me `*.ton` or `*.t.me` TON name, and I'll respond with detailed info about that domain (parsed from smartcontract internal data).

Only second-level domains are supported (e.g. `this.is.alice.t.me` is not allowed).
